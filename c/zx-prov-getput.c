...
/* FUNC(zx_prov_CallbackEPR_NUM_AltAddress) */
...
/* FUNC(zx_prov_CallbackEPR_GET_AltAddress) */
...
/* FUNC(zx_prov_CallbackEPR_POP_AltAddress) */
...
/* FUNC(zx_prov_CallbackEPR_PUSH_AltAddress) */

void zx_prov_CallbackEPR_PUSH_AltAddress(struct zx_prov_CallbackEPR_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
...
/* FUNC(zx_prov_CallbackEPR_REV_AltAddress) */
...
/* FUNC(zx_prov_CallbackEPR_PUT_AltAddress) */

void zx_prov_CallbackEPR_PUT_AltAddress(struct zx_prov_CallbackEPR_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_prov_CallbackEPR_ADD_AltAddress) */
...
/* FUNC(zx_prov_CallbackEPR_DEL_AltAddress) */
...
/* FUNC(zx_prov_ProvisioningServiceEPR_NUM_AltAddress) */
...
/* FUNC(zx_prov_ProvisioningServiceEPR_GET_AltAddress) */
...
/* FUNC(zx_prov_ProvisioningServiceEPR_POP_AltAddress) */
...
/* FUNC(zx_prov_ProvisioningServiceEPR_PUSH_AltAddress) */

void zx_prov_ProvisioningServiceEPR_PUSH_AltAddress(struct zx_prov_ProvisioningServiceEPR_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
...
/* FUNC(zx_prov_ProvisioningServiceEPR_REV_AltAddress) */
...
/* FUNC(zx_prov_ProvisioningServiceEPR_PUT_AltAddress) */

void zx_prov_ProvisioningServiceEPR_PUT_AltAddress(struct zx_prov_ProvisioningServiceEPR_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_prov_ProvisioningServiceEPR_ADD_AltAddress) */
...
/* FUNC(zx_prov_ProvisioningServiceEPR_DEL_AltAddress) */
