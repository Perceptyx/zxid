...
/* FUNC(zx_a_EndpointReference_NUM_AltAddress) */
...
int zx_a_EndpointReference_NUM_AltAddress(struct zx_a_EndpointReference_s* x)
{
  ...
  int n = 0;
  if (!x) return 0;
  for (y = x->AltAddress; y && y->g.tok == zx_elem_ELEM; ++n, y = (struct zx_elem_s*)y->g.n) ;
  return n;
}

/* FUNC(zx_a_EndpointReference_GET_AltAddress) */

struct zx_elem_s* zx_a_EndpointReference_GET_AltAddress(struct zx_a_EndpointReference_s* x, int n)
{
  struct zx_elem_s* y;
  if (!x) return 0;
  for (y = x->AltAddress; n>=0 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
  return y;
}

/* FUNC(zx_a_EndpointReference_POP_AltAddress) */
...
struct zx_elem_s* zx_a_EndpointReference_POP_AltAddress(struct zx_a_EndpointReference_s* x)
{
  ...
  y = x->AltAddress;
  if (y)
    x->AltAddress = (struct zx_elem_s*)y->g.n;
  return y;
}

/* FUNC(zx_a_EndpointReference_PUSH_AltAddress) */

void zx_a_EndpointReference_PUSH_AltAddress(struct zx_a_EndpointReference_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
}

/* FUNC(zx_a_EndpointReference_REV_AltAddress) */
...
void zx_a_EndpointReference_REV_AltAddress(struct zx_a_EndpointReference_s* x)
{
  ...
  while (y) {
    ...
    y->g.n = &x->AltAddress->g;
    x->AltAddress = y;
    y = nxt;
  }
}

/* FUNC(zx_a_EndpointReference_PUT_AltAddress) */

void zx_a_EndpointReference_PUT_AltAddress(struct zx_a_EndpointReference_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_a_EndpointReference_ADD_AltAddress) */
...
void zx_a_EndpointReference_ADD_AltAddress(struct zx_a_EndpointReference_s* x, int n, struct zx_elem_s* z)
{
  ...
  case -1:
    ...
    break;
  default:
    for (y = x->AltAddress; n > 1 && y && y->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y) return;
  }
  z->g.n = y->g.n;
  y->g.n = &z->g;
...
/* FUNC(zx_a_EndpointReference_DEL_AltAddress) */
...
void zx_a_EndpointReference_DEL_AltAddress(struct zx_a_EndpointReference_s* x, int n)
{
  ...
  switch (n) {
  case 0:
    x->AltAddress = (struct zx_elem_s*)x->AltAddress->g.n;
    return;
  case -1:
    y = (struct zx_elem_s*)x->AltAddress;
    if (!y) return;
    for (; y->g.n && y->g.n->g.tok == zx_elem_ELEM; y = (struct zx_elem_s*)y->g.n) ;
    break;
  default:
    for (y = x->AltAddress; n > 1 && y->g.n && y->g.n->g.tok == zx_elem_ELEM; --n, y = (struct zx_elem_s*)y->g.n) ;
    if (!y->g.n) return;
  }
  y->g.n = y->g.n->n;
}
...
/* FUNC(zx_a_FaultTo_NUM_AltAddress) */
...
/* FUNC(zx_a_FaultTo_GET_AltAddress) */
...
/* FUNC(zx_a_FaultTo_POP_AltAddress) */
...
/* FUNC(zx_a_FaultTo_PUSH_AltAddress) */

void zx_a_FaultTo_PUSH_AltAddress(struct zx_a_FaultTo_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
...
/* FUNC(zx_a_FaultTo_REV_AltAddress) */
...
/* FUNC(zx_a_FaultTo_PUT_AltAddress) */

void zx_a_FaultTo_PUT_AltAddress(struct zx_a_FaultTo_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_a_FaultTo_ADD_AltAddress) */
...
/* FUNC(zx_a_FaultTo_DEL_AltAddress) */
...
/* FUNC(zx_a_From_PUSH_AltAddress) */

void zx_a_From_PUSH_AltAddress(struct zx_a_From_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
...
/* FUNC(zx_a_From_PUT_AltAddress) */

void zx_a_From_PUT_AltAddress(struct zx_a_From_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_a_ReplyTo_NUM_AltAddress) */
...
/* FUNC(zx_a_ReplyTo_GET_AltAddress) */
...
/* FUNC(zx_a_ReplyTo_POP_AltAddress) */
...
/* FUNC(zx_a_ReplyTo_PUSH_AltAddress) */

void zx_a_ReplyTo_PUSH_AltAddress(struct zx_a_ReplyTo_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
...
/* FUNC(zx_a_ReplyTo_REV_AltAddress) */
...
/* FUNC(zx_a_ReplyTo_PUT_AltAddress) */

void zx_a_ReplyTo_PUT_AltAddress(struct zx_a_ReplyTo_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_a_ReplyTo_ADD_AltAddress) */
...
/* FUNC(zx_a_ReplyTo_DEL_AltAddress) */
