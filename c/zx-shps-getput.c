...
/* FUNC(zx_shps_CallbackEPR_NUM_AltAddress) */
...
/* FUNC(zx_shps_CallbackEPR_GET_AltAddress) */
...
/* FUNC(zx_shps_CallbackEPR_POP_AltAddress) */
...
/* FUNC(zx_shps_CallbackEPR_PUSH_AltAddress) */

void zx_shps_CallbackEPR_PUSH_AltAddress(struct zx_shps_CallbackEPR_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
...
/* FUNC(zx_shps_CallbackEPR_REV_AltAddress) */
...
/* FUNC(zx_shps_CallbackEPR_PUT_AltAddress) */

void zx_shps_CallbackEPR_PUT_AltAddress(struct zx_shps_CallbackEPR_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_shps_CallbackEPR_ADD_AltAddress) */
...
/* FUNC(zx_shps_CallbackEPR_DEL_AltAddress) */
