...
/* FUNC(zx_b_ApplicationEPR_NUM_AltAddress) */
...
/* FUNC(zx_b_ApplicationEPR_GET_AltAddress) */
...
/* FUNC(zx_b_ApplicationEPR_POP_AltAddress) */
...
/* FUNC(zx_b_ApplicationEPR_PUSH_AltAddress) */

void zx_b_ApplicationEPR_PUSH_AltAddress(struct zx_b_ApplicationEPR_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
...
/* FUNC(zx_b_ApplicationEPR_REV_AltAddress) */
...
/* FUNC(zx_b_ApplicationEPR_PUT_AltAddress) */

void zx_b_ApplicationEPR_PUT_AltAddress(struct zx_b_ApplicationEPR_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_b_ApplicationEPR_ADD_AltAddress) */
...
/* FUNC(zx_b_ApplicationEPR_DEL_AltAddress) */
...
/* FUNC(zx_b_EndpointUpdate_NUM_AltAddress) */
...
/* FUNC(zx_b_EndpointUpdate_GET_AltAddress) */
...
/* FUNC(zx_b_EndpointUpdate_POP_AltAddress) */
...
/* FUNC(zx_b_EndpointUpdate_PUSH_AltAddress) */

void zx_b_EndpointUpdate_PUSH_AltAddress(struct zx_b_EndpointUpdate_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
...
/* FUNC(zx_b_EndpointUpdate_REV_AltAddress) */
...
/* FUNC(zx_b_EndpointUpdate_PUT_AltAddress) */

void zx_b_EndpointUpdate_PUT_AltAddress(struct zx_b_EndpointUpdate_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_b_EndpointUpdate_ADD_AltAddress) */
...
/* FUNC(zx_b_EndpointUpdate_DEL_AltAddress) */
...
/* FUNC(zx_b_InteractionService_NUM_AltAddress) */
...
/* FUNC(zx_b_InteractionService_GET_AltAddress) */
...
/* FUNC(zx_b_InteractionService_POP_AltAddress) */
...
/* FUNC(zx_b_InteractionService_PUSH_AltAddress) */

void zx_b_InteractionService_PUSH_AltAddress(struct zx_b_InteractionService_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
  z->g.n = &x->AltAddress->g;
  x->AltAddress = z;
...
/* FUNC(zx_b_InteractionService_REV_AltAddress) */
...
/* FUNC(zx_b_InteractionService_PUT_AltAddress) */

void zx_b_InteractionService_PUT_AltAddress(struct zx_b_InteractionService_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_b_InteractionService_ADD_AltAddress) */
...
/* FUNC(zx_b_InteractionService_DEL_AltAddress) */
