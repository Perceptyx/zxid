...
/* FUNC(zx_wst_Issuer_NUM_AltAddress) */
...
/* FUNC(zx_wst_Issuer_GET_AltAddress) */
...
/* FUNC(zx_wst_Issuer_POP_AltAddress) */
...
/* FUNC(zx_wst_Issuer_PUSH_AltAddress) */

void zx_wst_Issuer_PUSH_AltAddress(struct zx_wst_Issuer_s* x, struct zx_elem_s* z)
{
  if (!x || !z) return;
...
/* FUNC(zx_wst_Issuer_REV_AltAddress) */
...
/* FUNC(zx_wst_Issuer_PUT_AltAddress) */

void zx_wst_Issuer_PUT_AltAddress(struct zx_wst_Issuer_s* x, int n, struct zx_elem_s* z)
{
  struct zx_elem_s* y;
  if (!x || !z) return;
  y = x->AltAddress;
...
/* FUNC(zx_wst_Issuer_ADD_AltAddress) */
...
/* FUNC(zx_wst_Issuer_DEL_AltAddress) */
