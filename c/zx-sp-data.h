...
#endif
/* -------------------------- sp_Status -------------------------- */
/* refby( zx_sp_LogoutResponse_s zx_sp_ManageNameIDResponse_s zx_sp_ArtifactResponse_s zx_sp_Response_s zx_sp_NameIDMappingResponse_s ) */
