...
*zx_rmemmem = *Net::SAMLc::zx_rmemmem;
...
*mk_uid = *Net::SAMLc::zxid_mk_uid;
*put_user_ses = *Net::SAMLc::zxid_put_user_ses;
*put_user_attr = *Net::SAMLc::zxid_put_user_attr;
...
*mk_mobconn_disco_req = *Net::SAMLc::zxid_mk_mobconn_disco_req;
*mk_mobconn_disco_call = *Net::SAMLc::zxid_mk_mobconn_disco_call;
...
*swig_az_url_get = *Net::SAMLc::zxid_entity_s_az_url_get;
*swig_az_url_set = *Net::SAMLc::zxid_entity_s_az_url_set;
*swig_token_url_get = *Net::SAMLc::zxid_entity_s_token_url_get;
*swig_token_url_set = *Net::SAMLc::zxid_entity_s_token_url_set;
*swig_userinfo_url_get = *Net::SAMLc::zxid_entity_s_userinfo_url_get;
*swig_userinfo_url_set = *Net::SAMLc::zxid_entity_s_userinfo_url_set;
*swig_client_id_get = *Net::SAMLc::zxid_entity_s_client_id_get;
*swig_client_id_set = *Net::SAMLc::zxid_entity_s_client_id_set;
*swig_client_secret_get = *Net::SAMLc::zxid_entity_s_client_secret_get;
*swig_client_secret_set = *Net::SAMLc::zxid_entity_s_client_secret_set;
sub new {
    my $pkg = shift;
...
*swig_state_opt_get = *Net::SAMLc::zxid_conf_state_opt_get;
*swig_state_opt_set = *Net::SAMLc::zxid_conf_state_opt_set;
*swig_res1_get = *Net::SAMLc::zxid_conf_res1_get;
*swig_res1_set = *Net::SAMLc::zxid_conf_res1_set;
*swig_res2_get = *Net::SAMLc::zxid_conf_res2_get;
*swig_res2_set = *Net::SAMLc::zxid_conf_res2_set;
*swig_res3_get = *Net::SAMLc::zxid_conf_res3_get;
*swig_res3_set = *Net::SAMLc::zxid_conf_res3_set;
*swig_res4_get = *Net::SAMLc::zxid_conf_res4_get;
*swig_res4_set = *Net::SAMLc::zxid_conf_res4_set;
*swig_res5_get = *Net::SAMLc::zxid_conf_res5_get;
*swig_res5_set = *Net::SAMLc::zxid_conf_res5_set;
*swig_res6_get = *Net::SAMLc::zxid_conf_res6_get;
*swig_res6_set = *Net::SAMLc::zxid_conf_res6_set;
*swig_res7_get = *Net::SAMLc::zxid_conf_res7_get;
*swig_res7_set = *Net::SAMLc::zxid_conf_res7_set;
...
*swig_client_secret_get = *Net::SAMLc::zxid_cgi_client_secret_get;
*swig_client_secret_set = *Net::SAMLc::zxid_cgi_client_secret_set;
*swig_scope_get = *Net::SAMLc::zxid_cgi_scope_get;
*swig_scope_set = *Net::SAMLc::zxid_cgi_scope_set;
*swig_denied_scopes_get = *Net::SAMLc::zxid_cgi_denied_scopes_get;
*swig_denied_scopes_set = *Net::SAMLc::zxid_cgi_denied_scopes_set;
*swig_granted_scopes_get = *Net::SAMLc::zxid_cgi_granted_scopes_get;
*swig_granted_scopes_set = *Net::SAMLc::zxid_cgi_granted_scopes_set;
...
*swig_token_url_get = *Net::SAMLc::zxid_cgi_token_url_get;
*swig_token_url_set = *Net::SAMLc::zxid_cgi_token_url_set;
*swig_userinfo_url_get = *Net::SAMLc::zxid_cgi_userinfo_url_get;
*swig_userinfo_url_set = *Net::SAMLc::zxid_cgi_userinfo_url_set;
*swig_sub_id_get = *Net::SAMLc::zxid_cgi_sub_id_get;
*swig_sub_id_set = *Net::SAMLc::zxid_cgi_sub_id_set;
*swig_mcc_mnc_get = *Net::SAMLc::zxid_cgi_mcc_mnc_get;
*swig_mcc_mnc_set = *Net::SAMLc::zxid_cgi_mcc_mnc_set;
...
*swig_idpeid_get = *Net::SAMLc::zxid_ses_idpeid_get;
*swig_idpeid_set = *Net::SAMLc::zxid_ses_idpeid_set;
*swig_tgteid_get = *Net::SAMLc::zxid_ses_tgteid_get;
*swig_tgteid_set = *Net::SAMLc::zxid_ses_tgteid_set;
...
*swig_issuer_meta_get = *Net::SAMLc::zxid_ses_issuer_meta_get;
*swig_issuer_meta_set = *Net::SAMLc::zxid_ses_issuer_meta_set;
...
*ART_DIR = *Net::SAMLc::ZXID_ART_DIR;
*PCODE_DIR = *Net::SAMLc::ZXID_PCODE_DIR;
*STATE_DIR = *Net::SAMLc::ZXID_STATE_DIR;
...
*FBC_CODE = *Net::SAMLc::ZXID_FBC_CODE;
*MOBCONN_CODE = *Net::SAMLc::ZXID_MOBCONN_CODE;
...
*MOBCONN1_REDIR = *Net::SAMLc::MOBCONN1_REDIR;
*FBC28_REDIR = *Net::SAMLc::FBC28_REDIR;
